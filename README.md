...
An Android smartphone application developed for this initiative enables families to register every member of their family, from the eldest grandfather to the youngest great-grandchild. Family trees and additional features have been added, along with a database. Other moderators who have been invited by registered moderators may change the membership.
